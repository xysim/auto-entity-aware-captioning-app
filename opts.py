...
def parse_opt():
    ...
    parser.add_argument('--cnn_model', type=str, default='resnet152',
                    help='resnet')
    parser.add_argument('--cnn_weight', type=str, default='mydata/resnet152-b121ed2d.pth',
    ...
    parser.add_argument('--save_checkpoint_every', type=int, default=4,
                    help='how often to save a model checkpoint (in iterations)?')
    parser.add_argument('--checkpoint_path', type=str, default='save/',
                    help='directory to store checkpointed models')
    parser.add_argument('--language_eval', type=int, default=1,
                    help='Evaluate language as well (1 = yes, 0 = no)? BLEU/CIDEr/METEOR/ROUGE_L? requires coco-caption code from Github.')
    parser.add_argument('--losses_log_every', type=int, default=2,
