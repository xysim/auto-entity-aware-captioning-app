...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default=g_datadir + 'news_dataset.json', help='input json file to process into hdf5')
  parser.add_argument('--output_json', default=g_datadir + 'data_news.json', help='output json file')
  parser.add_argument('--output_h5', default=g_datadir + 'data_news', help='output h5 file')
  ...
  parser.add_argument('--max_length', default=31, type=int, help='max length of a caption, in number of words. captions longer than this get clipped.')
