...
import eval_utils_ALL as eval_utils
import argparse
import misc.utils as utils
import torch
g_datadir = "ALL/data_ALL/"
g_data2dir = "data_ALL/"
...
parser.add_argument('--sen_embed_path', type=str, default=g_datadir + 'articles_full_avg.h5', #'./data/sen_embed/articles_compact_TBB.h5'
...
parser.add_argument('--input_label_h5', type=str, default=g_data2dir + 'data_news_label.h5',
                help='path to the h5file containing the preprocessed label')
parser.add_argument('--input_image_h5', type=str, default=g_data2dir + 'data_news_image.h5',
                help='path to the h5file containing the preprocessed image')
parser.add_argument('--input_json', type=str, default=g_data2dir + 'data_news.json',
...
parser.add_argument('--cnn_weight', type=str, default='../mydata/resnet152-b121ed2d.pth',           #'/home/abiten/.torch/models/resnet152-b121ed2d.pth',
                help='path to CNN tf model. Note this MUST be a resnet right now.')
parser.add_argument('--sentence_embed', type=str, default=g_data2dir + 'articles_full_avg.h5', #/media/abiten/SSD-DATA/breakingnews
